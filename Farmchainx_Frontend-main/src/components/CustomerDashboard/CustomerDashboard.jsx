...
function CustomerDashboard({ onLogout, user }) {
  ...
  const [isFruitClassifierOpen, setIsFruitClassifierOpen] = useState(false);
  ...
  return (
    <div className="dashboard customer-dashboard">
      ...
      {/* Cart Drawer — slides in over current page with blur */}
      <CartDrawer
        isOpen={isCartOpen}
        ...
        <div className="dashboard-content">
          <div className="dashboard-header">
            ...
            <div className="header-actions-group">
              <button
                className="fruit-classifier-btn"
                onClick={() => setIsFruitClassifierOpen(true)}
              >
                <span className="fruit-classifier-icon">🍎</span>
                Fruit Classifier
              </button>
          ...
          {/* Fruit Classifier Modal */}
          {isFruitClassifierOpen && (
            <FruitClassifier onClose={() => setIsFruitClassifierOpen(false)} />
          )}
        </div>
      </div>
    </div>
